Feature: The item store service back-end
    As a Item Store Owner
...
Scenario: The server is running
    ...
    Then I should see "Item Demo RESTful Service" in the title
    And I should not see "404 Not Found"

Scenario: Create a Item
    When I visit the "Home Page"
    And I set the "Name" to "Happy"
    And I set the "Price" to "Hippo"
